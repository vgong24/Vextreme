...
- 119/119 tests passed after all three PRs (78 baseline + 10 viewmodel + 22 build-vextreme + 9 build-sw = wait, the count in the summary says 100/100 after PR #24 and 119/119 after PR #25... the numbers suggest test counts changed; the final 119 is authoritative).
