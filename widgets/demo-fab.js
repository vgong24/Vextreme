/**
 * VEXTREME — widgets/demo-fab.js
 *
 * Floating orb linking to the architecture demo page (pages/vextreme-demo.html).
 * Sits next to widgets/lang-fab.js (44px, translucent, top-right) but offset
 * left of it so both can mount on the same page without overlapping.
 *
 * This is the first of what may become a family of orbs around a central FAB
 * (a "left orb = demo mode" style radial menu). Deliberately NOT built as a
 * generalized radial-menu framework yet — one real menu item doesn't justify
 * that abstraction. If/when a second orb is needed, generalize then.
 *
