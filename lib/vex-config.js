 ...
 *               lib/check-institutional-surfaces.js
...
const Feature = {
  ...
  ANALYSIS:   'analysis',     // Analysis Mode orb — search/browse panel over data/analysis-index.json (docs/architecture/15-analysis-mode.md)
};
