 ...
 *   reads     : nothing
 *   writes    : nothing (imported by build scripts and tests)
 *   loaded-by : lib/build-index.js, lib/build-vextreme.js, lib/strings-compile.js,
 *               lib/strings-check.js, lib/strings-export.js, lib/strings-import.js,
 *               lib/build-archives.js, lib/build-specimens.js, lib/validate-blueprint.js,
 *               tests/05-vex-config.test.js, tests/06-blueprint.test.js,
 *               tests/07-viewmodel.test.js, tests/08-build-vextreme.test.js
 *   tested-by : tests/05-vex-config.test.js, tests/06-blueprint.test.js
 *
 * CHANGE MAP — if you touch X here, also check:
 *   Feature.* added/renamed   → blueprint.json features[], config/features/{id}.json (create),
 *                                lib/build-vextreme.js FEATURES registry,
 *                                tests/06-blueprint.test.js (coverage check)
 *   Category.* added/renamed  → blueprint.json categories[], config/categories/{id}.json (create),
 *                                data/strings/source/ _meta.category values,
 *                                lib/strings-compile.js path derivation
 *   Language.* added          → lib/strings-compile.js, lib/strings-check.js,
 *                                data/status/tech-debt.json (td-006 trigger condition)
 *   scopeRelPath() changed    → widgets/fab-lang.js applies the same rule at runtime —
 *                                must stay identical or scope fetches will 404
 */
