...
<head>
  ...
  <style>
    ...
    /* Nav header */
    .page-nav { display: flex; gap: 20px; margin-bottom: 2rem; font-family: var(--font-mono); font-size: 11px; }
    .page-nav a { color: var(--stone-400, #888); text-decoration: none; letter-spacing: 0.04em; }
    .page-nav a:hover { color: var(--ember); }
    .page-nav a.current { color: var(--stone-200, #ddd); }
    ...
    .section h2 { font-size: 1rem; font-weight: 600; text-transform: uppercase; letter-spacing: 0.08em; color: var(--stone-300); border-bottom: 1px solid var(--stone-800); padding-bottom: 0.5rem; margin: 0; flex: 1; }
    .section-link { font-size: 0.75rem; color: var(--ember); text-decoration: none; white-space: nowrap; font-family: var(--font-mono); }
...
<body>
  ...
  <div class="hub-header">
    <h1>Ecosystem Hub</h1>
    <p>System health and content statistics. Full page registry at <a href="${ARCHIVES_URL}">Archives</a>.</p>
  </div>
