...
<header class="site-header">
  <div class="site-title" data-i18n="common.label.site-title">${t('common.label.site-title')}</div>
  <h1 class="site-sub" data-i18n="archives.heading.page-title">${t('archives.heading.page-title')}</h1>
  <div class="site-meta">
...
<div class="global-bar-wrap">
  <div class="global-bar-label">
    <span data-i18n="archives.label.overall-progress">${t('archives.label.overall-progress')}</span>
...
<div class="legend">
  <div class="legend-item"><div class="legend-dot legend-dot--ported"></div> <span data-i18n="common.label.page-live">${t('common.label.page-live')}</span></div>
  <div class="legend-item"><div class="legend-dot legend-dot--missing"></div> <span data-i18n="common.label.not-yet-ported">${t('common.label.not-yet-ported')}</span></div>
</div>

${arcSections}

<div id="slugPopover" class="slug-popover" style="display:none">
  <div class="slug-popover-label" data-i18n="common.label.slug">${t('common.label.slug')}</div>
  <div class="slug-popover-value" id="slugPopoverSlug"></div>
  <div class="slug-popover-filename" id="slugPopoverFile"></div>
  <button class="slug-popover-copy" id="slugPopoverBtn">${t('common.button.copy-filename')}</button>
</div>

<script>
(function () {
  var COPY_LABEL   = ${JSON.stringify(t('common.button.copy-filename'))};
  var COPIED_LABEL = ${JSON.stringify(t('common.button.copied'))};
